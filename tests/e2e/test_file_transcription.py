...
class TestWhisperCppFileTranscription:
    def test_jfk_transcription_contains_expected_text(self, jfk_wav, wcpp_config):
        ...
        result = transcribe_with_config(jfk_wav, wcpp_config, raise_on_error=True)
    ...
    def test_direct_wc_transcribe(self, jfk_wav, wcpp_config):
        """Call the whisper_cpp backend directly, bypassing transcribe_with_config."""
        cfg = WhisperCppConfig.from_config(wcpp_config)
